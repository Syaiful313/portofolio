          ...
          >
            ...
            <CardFooter className="p-4">
              <Link
                ...
                className="inline-block text-sm font-semibold text-[#d9c5a7] border border-[#d9c5a7] rounded-full px-4 py-1 hover:bg-yellow-500 hover:text-gray-900 transition-colors duration-300"
              >
